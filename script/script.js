$(document).ready(function () {
    ...
    $z.interDown = function () {
      if ($z.l < 1) {
        $z.interD = setInterval(function () {
          ...
          let $winW1 =
            $(".position").offset().left - $(".position_3").offset().left;
          let $winW2 =
            $(".position_2").offset().top - $(".position_3").offset().top;
          let Wbol = $winW1 / 2;
          let Wkop = $winW2 / 2;
          $blk.css("left", `${$z.i}px`);
          $blk.css("top", `${$z.j}px`);
    ...
    $z.BotMoveLt = function () {
      if (l == 0) {
        $z.interBot = setInterval(function () {
          ...
          let $winW2 =
            $(".position_2").offset().top - $(".position_3").offset().top;
          let Rrand1 = Math.floor(
            Math.random() * 250 + ($blk.offset().top - $winW2 - 300)
          ); // top
          let Rrand2 = Math.floor(
            Math.random() * ($winW1 + 600) +
              ($blk.offset().left - $winW1 / 2 - 300)
          );
          let Rrand3 = Math.floor(
            Math.random() * ($winW2 + 600) +
              ($blk.offset().top - $winW2 / 2 - 300)
          ); // left
          let Rrand4 = Math.floor(
            Math.random() * 250 + ($blk.offset().left - $winW1 / 2 - 300)
          );
          let Rrand5 = Math.floor(
            Math.random() * 250 + ($blk.offset().top + $winW2 / 2 + 50)
          ); // bottom
          let Rrand6 = Math.floor(
            Math.random() * ($winW1 + 600) +
              ($blk.offset().left - $winW1 / 2 - 300)
          );
          let Rrand7 = Math.floor(
            Math.random() * ($winW2 + 600) +
              ($blk.offset().top - $winW2 / 2 - 300)
          ); // right
          let Rrand8 = Math.floor(
            Math.random() * 250 + ($blk.offset().left + $winW1 / 2 + 50)
          );
          if ($z.degB <= 90) {
  ...
  $boxBotStopInt = setInterval(function () {
    ...
    $(".count").each(function () {
      ...
      if (
        $stopCntT >= $contPosT - ($winW2 / 2 + 150) &&
        $stopCntL >= $contPosL - ($winW1 / 2 + 150) &&
        $stopCntT <= $contPosT + ($winW2 / 2 + 150) &&
        $stopCntL <= $contPosL + ($winW1 / 2 + 150)
      ) {
            ...
            $cnt1.each(function () {
              ...
              $cont.each(function () {
                ...
                if (
                  ...
                  if (
                    $z.parent().parent().attr("data-block") == "stop" &&
                    i == 0
                  ) {
                    setTimeout(function () {
                      $(".overlay").show();
